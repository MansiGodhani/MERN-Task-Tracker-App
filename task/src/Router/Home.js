        ...
        <div class="Tasktracker ">
            ...
            <form>
                <div class="form-control">
                    ...
                    <input onChange={(e)=>taskdata.title = e.target.value} placeholder='Add Title'/>
                </div>
                <div class="form-control">
                    <label>Task Description</label>
                    <input onChange={(e)=> taskdata.desc = e.target.value} placeholder='Add Task Desc'/>
                </div>
            ...
            <div className='form-control'>
                <label>Task Title</label>
                <input onChange={(e)=> taskdata.title = e.target.value} placeholder={Update.title}/>
            </div>
            <div className='form-control'>
                <label>Task Description</label>
                <input onChange={(e)=> taskdata.desc = e.target.value} placeholder={Update.desc}/>
            </div>
            <div className='form-control'>
                <label>Add Date & Time</label>
                <input id='mydate' onClick={changetype} onChange={(e)=>  taskdata.date = e.target.value} placeholder={Update.date}/>
            </div>
